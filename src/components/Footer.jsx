			...
			<div className="bg-black/85">
					...
					<div className="grid grid-cols-2 lg:grid-cols-4 gap-x-7 mb-6 cursor-pointer">
						<div className=" pb-2">
							<ul className="mb-0 list-none">
								...
								<li>
									Trụ sở chính: 254 Nguyễn Văn Linh, Quận Thanh Khê, Thành phố Đà Nẵng, Việt Nam
								</li>
							</ul>
						</div>
						<div className="pb-2">
							<ul className="mb-0 list-none">
								...
								<li>
									<p className='hover:underline flex gap-2'>
										Email:
										<h4 className='text-primary'>hotro@itviet.com</h4>
									</p>
								</li>
							</ul>
						</div>
				...
				<div className="flex items-center justify-center text-white font-semibold bg-primary/75 p-2 text-center w-full">
					<div className='flex items-center gap-2 '>
						...
						<Icon icon='ph:copyright-bold' height={27}></Icon>
						<h1 className='pr-5'>
							Copyright 2024 ITVIET Corporation. All Right Reserved
						</h1>
						<div className='flex gap-2 items-center'>
							<Icon icon='cib:facebook' className='hover:cursor-pointer' ></Icon>
							<Icon icon='mdi:gmail' className='hover:cursor-pointer' height={21}></Icon>
							<Icon icon='cib:youtube' className='hover:cursor-pointer' height={21}></Icon>
						</div>
					</div>
				</div>
			</div>
